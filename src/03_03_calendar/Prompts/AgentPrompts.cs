namespace FourthDevs.Calendar.Prompts
{
    public static class AgentPrompts
    {
        public static string BuildAddPhasePrompt()
        {
...
After tool calls, respond with one short confirmation sentence.";
        ...
        public static string BuildNotificationPhasePrompt()
        {
            return @"You are a proactive event notification assistant.
