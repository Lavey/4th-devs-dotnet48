...
- Code runs in a Jint (JavaScript) sandbox — isolated from the host system
...
- **Tool calls are synchronous** — call them directly: `var result = todo.create({title: "Buy milk"})`. Do NOT use `async/await`.
