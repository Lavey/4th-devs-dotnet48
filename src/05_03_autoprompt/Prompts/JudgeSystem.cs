...
namespace FourthDevs.AutoPrompt.Prompts
{
    public static class JudgeSystem
    {
        public static string Build(EvaluationConfig evaluation)
        {
            string policy = EvaluationPolicy.Format(evaluation);

            return string.Format(
@"You are a strict evaluation judge. You compare an LLM's actual extraction outputs against expected ground truth for multiple test cases.
